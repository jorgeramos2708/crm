export const env = {
  ...
  DATABASE_URL: process.env.DATABASE_URL || 'postgres://crm:crm_dev_password@postgres:5432/crm',
  REDIS_URL: process.env.REDIS_URL || 'redis://redis:6379',
  
  CORS_ORIGIN: process.env.CORS_ORIGIN || 'http://localhost:8081',
  
  SESSION_SECRET: process.env.SESSION_SECRET || 'crm-super-secret-change-in-production-min-32-chars',
  SESSION_COOKIE: process.env.SESSION_COOKIE || 'crm_session',
  SESSION_TTL_SECONDS: parseInt(process.env.SESSION_TTL_SECONDS || '604800', 10), // 7 días
  ...
  JWT_SECRET: process.env.JWT_SECRET || 'jwt-secret-change-in-production-min-32-chars',
  ...
  CURRENCY: ['USD', 'MXN'].includes(process.env.CURRENCY || '') ? process.env.CURRENCY as string : 'MXN',
